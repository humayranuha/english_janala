...
const displayWordDetails = (word) => {
    ...
    // If you have a <dialog> element, call showModal on it separately:
    ...
    words.forEach(word => {
        ...
        card.innerHTML = `
            <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
                ...
                <div class="text-xl font-semibold font-bangla">"${word.meaning ? word.meaning : "No meaning found"} / ${word.pronunciation ? word.pronunciation : "No Pronunciation"}"</div>
                <div class="flex justify-between items-center">
                    <button onclick="loadWordDetail(${word.id})" class="btn bg-[#a2bdd6] hover:bg-[#4f71b1]">
                    <i class="fa-solid fa-circle-info"></i>
                    </button>
                    <button onclick="pronounceWord('${word.word}')" class="btn bg-[#a2bdd6] hover:bg-[#4f71b1]">
...
const displayLessons = (lessons) => {
    ...
    for (let lesson of lessons) {
        ...
        btnDiv.innerHTML = `
            ...
            <span><i class="fa-solid fa-book-open"></i></span> Lesson - ${lesson.level_no}</button>
        `;
